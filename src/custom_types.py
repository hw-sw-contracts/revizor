...
CombinedHTrace = int
InputList = List[int]
# Dependencies information contains: 1) base input value, 2) target input
# value, 3) dependencies values
# Intuitively: 
# Contract trace produced by configuration generated by base input value +
# changes in dependencies value should be the same as contract trace generated
# on target input value
Dependencies = Tuple[Input,Input,Dict]
